...
/**
 * @title Ownable
 * @dev Provides basic access control, where there is an owner that can be granted exclusive access to specific functions.
 */
...
/**
 * @title ERC20Burnable
 * @dev Extension of ERC20 that allows token holders to destroy their tokens.
 */
...
/**
 * @title Zyro
 * @dev Zyro token contract with 90 billion initial supply, burnable, owner-controlled distribution, and blacklist functionality.
 * Compatible with BNB Chain (BEP-20).
 */
contract Zyro is ERC20, ERC20Burnable, Ownable {
    ...
    /**
     * @dev Overrides the _beforeTokenTransfer to ensure blacklist checks are applied during minting and burning.
     */
